...
\begin{align*}
    S &\to \textcolor{orange!80!black}{aB}
     \mid S
     \mid b
     \mid \colorbox{yellow!50}{AaB}
    \\
    A &\to \textcolor{gray}{\varepsilon}
     \mid \colorbox{yellow!50}{AB}
     \mid S
     \mid \textcolor{orange!80!black}{B}
    \\
    B &\to \textcolor{orange!80!black}{AS}
     \mid \textcolor{orange!80!black}{SA}
     \mid \colorbox{yellow!50}{ASA}
...
\begin{align*}
    S &\to aB  \mid S  \mid b  \mid AaB \\
    A &\to AB  \mid S  \mid B \\
    B &\to AS  \mid SA  \mid ASA  \mid S  \mid bbb \\
    S_0 &\to S \\
    \end{align*}
...
\begin{itemize}
    ...
    \item \textbf{Action:} Add these productions to $A$: \quad $aB \mid b \mid AaB$
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
    ...
    \item \textbf{Distance:} 1 step
    \item \textbf{Action:} Add these productions to $A$: \quad $AS \mid SA \mid ASA \mid bbb$
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
    ...
    \item \textbf{Distance:} 1 step
    \item \textbf{Action:} Add these productions to $B$: \quad $aB \mid b \mid AaB$
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
    ...
    \item \textbf{Distance:} 1 step
    \item \textbf{Action:} Add these productions to $S_0$: \quad $aB \mid b \mid AaB$
\end{itemize}
\end{tcolorbox}
...
\begin{align*}
    S &\to aB \mid b \mid AaB\\
    A &\to \textcolor{orange!80!black}{AS} \mid \textcolor{orange!80!black}{SA} \mid \textcolor{orange!80!black}{ASA} \mid \textcolor{orange!80!black}{b} \mid \textcolor{orange!80!black}{AaB} \mid AB \mid \textcolor{orange!80!black}{aB} \mid \textcolor{orange!80!black}{bbb}\\
    B &\to AS \mid SA \mid ASA \mid \textcolor{orange!80!black}{b} \mid \textcolor{orange!80!black}{AaB} \mid \textcolor{orange!80!black}{aB} \mid bbb\\
    S_0 &\to \textcolor{orange!80!black}{aB} \mid \textcolor{orange!80!black}{b} \mid \textcolor{orange!80!black}{AaB}\\
    \end{align*}
...
\begin{align*}
    ...
    A &\to AS \mid SA \mid b \mid AB \mid U_aB \mid DA \mid EU_b \mid CB\\
    B &\to AS \mid SA \mid b \mid U_aB \mid DA \mid EU_b \mid CB\\
