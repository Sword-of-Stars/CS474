...
\begin{align*}\delta(1,\,a) &= 2\\[0.5em]\delta(1,\,b) &= 4\\[1em]\delta(2,\,a) &= 4\\[0.5em]\delta(2,\,b) &= 3\\[1em]\delta(3,\,a) &= 3\\[0.5em]\delta(3,\,b) &= 3\\[1em]\delta(4,\,a) &= 4\\[0.5em]\delta(4,\,b) &= 5\\[1em]\delta(5,\,a) &= 5\\[0.5em]\delta(5,\,b) &= 5\\[1em]\delta(6,\,a) &= 4\\[0.5em]\delta(6,\,b) &= 6
\end{align*}
...
\textbf{Explanation:} Initially marked pairs where one state is final and the other non‑final: 1,3, 1,5, 2,3, 2,5, 3,4, 3,6, 4,5, 5,6
...
\textbf{Explanation:} Newly marked pairs: 1,2, 1,4, 2,6, 4,6
...
\textbf{Explanation:} Newly marked pairs: 1,6
