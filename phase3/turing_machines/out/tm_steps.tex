...
\begin{align*}\delta(q0,\,0) &= (x,\,R,\,q1)\\[0.5em]\delta(q0,\,1) &= (x,\,R,\,q1)\\[0.5em]\delta(q0,\,$\sqcup$) &= ($\sqcup$,\,R,\,q2)\\[0.5em]\delta(q1,\,0) &= (0,\,R,\,q0)\\[0.5em]\delta(q1,\,1) &= (1,\,R,\,q0)\\[0.5em]\delta(q1,\,$\sqcup$) &= ($\sqcup$,\,R,\,q2)
\end{align*}
...
\textbf{Explanation:}
\newline In the initial configuration, the Turing Machine loads the input tape. The head is positioned at the starting cell (index \textbf0), reading the symbol \textbf{`1`}. Since no transition has been performed yet, no rewriting occurs.
...
\begin{itemize}
    \item The head is positioned at cell index \textbf1, reading the symbol \textbf{`1'}.
    \item The machine rewrites this cell with \textbf{`0'} (if different from the original symbol).
    \item The machine then moves the head and changes its state to \textbfq1.
\end{itemize}
...
\newline In this transition:
\begin{itemize}
    \item The head is positioned at cell index \textbf2, reading the symbol \textbf{`0'}.
    \item The machine rewrites this cell with \textbf{`1'} (if different from the original symbol).
    \item The machine then moves the head and changes its state to \textbfq0.
\end{itemize}
This step-by-step process is illustrated in the figure below.
...
\newline In this transition:
\begin{itemize}
    \item The head is positioned at cell index \textbf3, reading the symbol \textbf{`1'}.
    \item The machine rewrites this cell with \textbf{`0'} (if different from the original symbol).
    \item The machine then moves the head and changes its state to \textbfq1.
\end{itemize}
This step-by-step process is illustrated in the figure below.
...
\newline In this transition:
\begin{itemize}
    \item The head is positioned at cell index \textbf4, reading the symbol \textbf{`0'}.
    \item The machine rewrites this cell with \textbf{`1'} (if different from the original symbol).
    \item The machine then moves the head and changes its state to \textbfq0.
\end{itemize}
This step-by-step process is illustrated in the figure below.
...
\newline In this transition:
\begin{itemize}
    \item The head is positioned at cell index \textbf5, reading the symbol \textbf{`1'}.
    \item The machine rewrites this cell with \textbf{`$\sqcup$'} (if different from the original symbol).
    \item The machine then moves the head and changes its state to \textbfq1.
\end{itemize}
This step-by-step process is illustrated in the figure below.
...
\newline In this transition:
\begin{itemize}
    \item The head is positioned at cell index \textbf6, reading the symbol \textbf{`$\sqcup$'}.
    \item The machine rewrites this cell with \textbf{`$\sqcup$'} (if different from the original symbol).
    \item The machine then moves the head and changes its state to \textbfq2.
\end{itemize}
This step-by-step process is illustrated in the figure below.
...
\begin{itemize}
    \item The head is positioned at cell index \textbf6, reading the symbol \textbf{`$\sqcup$'}.
    \item The machine rewrites this cell with \textbf{`None'} (if different from the original symbol).
    \item The machine then moves the head and changes its state to \textbfq2.
\end{itemize}
This step-by-step process is illustrated in the figure below.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{plots/plot8.png}
    \caption{Configuration at Transition 8}
\end{figure}
\end{document}